//  ============== SCROLLING ANIMATION FUNCTION ===========
    ...
    //Slow Scroll
    jQuery('header.lnd-pg nav ul li a').on("click", function (e) {
    ...
    jQuery('header.lnd-pg nav ul li').removeClass('active').find('a[href*="#' + currentSection + '"]').parent().addClass('active');
});